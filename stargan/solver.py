...
class Solver(object):
    ...
    def create_labels(self, c_org, c_dim=5, dataset='CelebA', selected_attrs=None):
        ...
        # # For multiple attribute transfer
        # if dataset == 'CelebA':
        #     c_trg_1 = c_trg_list[0].clone()
        #     c_trg_2 = c_trg_list[0].clone()
        #     c_trg_3 = c_trg_list[3].clone()
        #     # 0: Black, 1: Blond, 2: Brown, 3: Male, 4:Young
        #     # (0, 3), (0, 4), (3, 4), (0, 3, 4)
        #     c_trg_1[:, 3] = (c_trg_1[:, 3] == 0)
        #     c_trg_2[:, 4] = (c_trg_2[:, 4] == 0)
        #     c_trg_3[:, 4] = (c_trg_3[:, 4] == 0)

        #     c_trg_4 = c_trg_1.clone()
        #     c_trg_4[:, 4] = (c_trg_4[:, 4] == 0)


        #     c_trg_list.append(c_trg_1.to(self.device))
        #     c_trg_list.append(c_trg_2.to(self.device))
        #     c_trg_list.append(c_trg_3.to(self.device))
        #     c_trg_list.append(c_trg_4.to(self.device))
